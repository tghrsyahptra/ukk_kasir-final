  ...
  var Xn = Cn.extend({
      ...
      _drawGrid: function () {
        ...
        if (
          ...
          for (
            a.save(), a.lineWidth = l, a.strokeStyle = u, a.setLineDash && (a.setLineDash(Wn([s.borderDash, o.borderDash, []])), (a.lineDashOffset = Wn([s.borderDashOffset, o.borderDashOffset, 0]))), t = i.chart.data.labels.length - 1;
            t >= 0;
            t--
          )
  ...
  var wi = {
      ...
      beforeDatasetsDraw: function (t) {
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            e.visible &&
            ((a = (i = e.el)._view), (r = i._children || []), (o = e.mapper), (s = a.backgroundColor || N.global.defaultColor), o && s && r.length && (H.canvas.clipArea(u, t.chartArea), ki(u, r, o, a, s, i._loop), H.canvas.unclipArea(u)));
      },
    },
