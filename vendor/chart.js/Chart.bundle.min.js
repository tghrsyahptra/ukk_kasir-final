...
!(function (t, e) {
  ...
  var E = {
      ...
      toPadding: function (t) {
        var e, n, i, a;
        return D.isObject(t) ? ((e = +t.top || 0), (n = +t.right || 0), (i = +t.bottom || 0), (a = +t.left || 0)) : (e = n = i = a = +t || 0), { top: e, right: n, bottom: i, left: a, height: e + i, width: a + n };
      },
  ...
  B.extend(it.prototype, {
    ...
    _resolveDataElementOptions: function (t, e) {
      ...
      var r,
        ...
        m = { cacheable: !i };
      if (((i = i || {}), B.isArray(c))) for (o = 0, s = c.length; o < s; ++o) f[(l = c[o])] = tt([i[l], d[l], h[l]], g, e, m);
      else for (o = 0, s = (r = Object.keys(c)).length; o < s; ++o) f[(l = r[o])] = tt([i[l], d[c[l]], d[l], h[l]], g, e, m);
      ...
      n.fullCircles &&
        (function (t, e, n, i) {
          var a,
            r = n.endAngle;
          for (
            i && ((n.endAngle = n.startAngle + rt), ot(t, n), (n.endAngle = r), n.endAngle === n.startAngle && n.fullCircles && ((n.endAngle += rt), n.fullCircles--)),
              t.beginPath(),
  ...
  Y._set('global', { elements: { line: { tension: 0.4, backgroundColor: dt, borderWidth: 3, borderColor: dt, borderCapStyle: 'butt', borderDash: [], borderDashOffset: 0, borderJoinStyle: 'miter', capBezierPoints: !0, fill: !0 } } });
  var ht = X.extend({
      _type: 'line',
      draw: function () {
        var t,
        ...
        if (s.length) {
          ...
          for (
            ...
            (n = s[t]._view), (e = -1 === d ? B.previousItem(s, t) : s[d]), n.skip || ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : B.canvas.lineTo(r, e._view, n), (d = t));
      ...
      draw: function (t) {
        ...
        e.skip ||
          ((void 0 === t || B.canvas._isPointInArea(e, t)) &&
            ((n.strokeStyle = e.borderColor || u), (n.lineWidth = ct(e.borderWidth, l.elements.point.borderWidth)), (n.fillStyle = e.backgroundColor || u), B.canvas.drawPoint(n, i, r, o, s, a)));
      },
    }),
  ...
  function bt(t) {
    var e, n, i, a, r;
    return (
      vt(t) ? ((r = t.width / 2), (e = t.x - r), (n = t.x + r), (i = Math.min(t.y, t.base)), (a = Math.max(t.y, t.base))) : ((r = t.height / 2), (e = Math.min(t.x, t.base)), (n = Math.max(t.x, t.base)), (i = t.y - r), (a = t.y + r)),
  ...
  function xt(t, e, n) {
    ...
    return (
      B.isObject(s) ? ((i = +s.top || 0), (a = +s.right || 0), (r = +s.bottom || 0), (o = +s.left || 0)) : (i = a = r = o = +s || 0),
  ...
  function Ot(t, e, n) {
    var i,
      ...
      l = B.isNullOrUndef(r)
        ...
        : -1;
    return B.isNullOrUndef(r) ? ((i = l * n.categoryPercentage), (a = n.barPercentage)) : ((i = r * o), (a = 1)), { chunk: i / o, ratio: a, start: s - i / 2 };
  }
  Y._set('bar', { hover: { mode: 'label' }, scales: { xAxes: [{ type: 'category', offset: !0, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: 'linear' }] } }),
  ...
  function Gt(t) {
    var e, n, i, a;
    return B.isObject(t) ? ((e = t.top), (n = t.right), (i = t.bottom), (a = t.left)) : (e = n = i = a = t), { top: e, right: n, bottom: i, left: a };
  }
  Y._set('line', { showLines: !0, spanGaps: !1, hover: { mode: 'label' }, scales: { xAxes: [{ type: 'category', id: 'x-axis-0' }], yAxes: [{ type: 'linear', id: 'y-axis-0' }] } });
  var qt = at.extend({
      ...
      updateBezierControlPoints: function () {
        ...
        if (a.options.elements.line.capBezierPoints)
          for (t = 0, e = l.length; t < e; ++t)
            (n = l[t]._model),
              Bt(n, s) &&
                (t > 0 && Bt(l[t - 1]._model, s) && ((n.controlPointPreviousX = u(n.controlPointPreviousX, s.left, s.right)), (n.controlPointPreviousY = u(n.controlPointPreviousY, s.top, s.bottom))),
                t < l.length - 1 && Bt(l[t + 1]._model, s) && ((n.controlPointNextX = u(n.controlPointNextX, s.left, s.right)), (n.controlPointNextY = u(n.controlPointNextY, s.top, s.bottom))));
      },
      draw: function () {
        var t,
          e = this.chart,
        ...
        for (
          ...
          B.canvas.clipArea(e.ctx, { left: !1 === t.left ? 0 : a.left - t.left, right: !1 === t.right ? r.width : a.right + t.right, top: !1 === t.top ? 0 : a.top - t.top, bottom: !1 === t.bottom ? r.height : a.bottom + t.bottom }),
          n.dataset.draw(),
  ...
  var Ue = X.extend({
      ...
      handleEvent: function (t) {
        ...
        return (
          ...
          (e = !B.arrayEquals(n._active, n._lastActive)) && ((n._lastActive = n._active), (i.enabled || i.custom) && ((n._eventPosition = { x: t.x, y: t.y }), n.update(!0), n.pivot())),
          e
        );
      },
    }),
  ...
  function pn(t, e) {
    return B.extend(B.options._parseFont({ fontFamily: dn(e.fontFamily, t.fontFamily), fontSize: dn(e.fontSize, t.fontSize), fontStyle: dn(e.fontStyle, t.fontStyle), lineHeight: dn(e.lineHeight, t.lineHeight) }), {
  ...
  Y._set('scale', {
    ...
    ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: sn.formatters.values, minor: {}, major: {} },
  });
  var xn = X.extend({
    zeroLineIndex: 0,
    getPadding: function () {
    ...
    _parseValue: function (t) {
      var e, n, i, a;
      return ln(t) ? ((e = +this.getRightValue(t[0])), (n = +this.getRightValue(t[1])), (i = Math.min(e, n)), (a = Math.max(e, n))) : ((e = void 0), (n = t = +this.getRightValue(t)), (i = t), (a = t)), { min: i, max: a, start: e, end: n };
    },
        ...
        (i = S[n] || {}),
          (un(i.label) && n < S.length) ||
            (n === b.zeroLineIndex && x.offset === k
              ...
              : ((g = hn(_.lineWidth, n, 1)), (m = hn(_.color, n, 'rgba(0,0,0,0.1)')), (p = _.borderDash || []), (v = _.borderDashOffset || 0)),
    ...
    kn = _n.extend({
      ...
      _configure: function () {
        var t = this,
          e = t.options.offset,
          n = t.ticks;
        _n.prototype._configure.call(t), t.isHorizontal() || (t._reversePixels = !t._reversePixels), n && ((t._startValue = t.minIndex - (e ? 0.5 : 0)), (t._valueRange = Math.max(n.length - (e ? 0 : 1), 1)));
      },
      getPixelForValue: function (t, e, n) {
        ...
        return (
          ...
          (void 0 !== i || (void 0 !== t && isNaN(e))) && ((a = o._getLabels()), (t = B.valueOrDefault(i, t)), (e = -1 !== (r = a.indexOf(t)) ? r : e), isNaN(e) && (e = t)),
        ...
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            (r = Math.ceil(g / m) - Math.floor(f / m)) > u && (m = B.niceNum((r * m) / u / l) * l),
              s || Dn(c) ? (n = Math.pow(10, B._decimalPlaces(m))) : ((n = Math.pow(10, c)), (m = Math.ceil(m * n) / n)),
              (i = Math.floor(f / m) * m),
              (a = Math.ceil(g / m) * m),
              s && (!Dn(d) && B.almostWhole(d / m, m / 1e3) && (i = d), !Dn(h) && B.almostWhole(h / m, m / 1e3) && (a = h)),
              (r = (a - i) / m),
  ...
  var Wn = _n.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = Nn(e.min, t.min)),
          ...
          t.min === t.max && (0 !== t.min && null !== t.min ? ((t.min = Math.pow(10, Math.floor(Ln(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(Ln(t.max)) + 1))) : ((t.min = 1), (t.max = 10))),
      ...
      _configure: function () {
        ...
        _n.prototype._configure.call(t),
          0 === e && ((e = t._getFirstTickValue(t.minNotZero)), (n = In(t.options.ticks.fontSize, Y.global.defaultFontSize) / t._length)),
          (t._startValue = Ln(e)),
          (t._valueOffset = n),
  ...
  var zn = B.valueOrDefault,
    ...
    Hn = {
      ...
      ticks: { showLabelBackdrop: !0, backdropColor: 'rgba(255,255,255,0.75)', backdropPaddingY: 2, backdropPaddingX: 2, callback: sn.formatters.linear },
      pointLabels: {
        display: !0,
        fontSize: 10,
        callback: function (t) {
  ...
  var $n = Cn.extend({
          ...
          ? (function (t) {
              ...
              for (e = 0; e < d; e++) {
                (i = t.getPointPosition(e, t.drawingArea + 5)),
                  ...
                  (l = a.lineHeight),
                  (u = t.pointLabels[e]),
                  (n = B.isArray(u) ? { w: B.longestText(s, s.font, u), h: u.length * l } : { w: s.measureText(u).width, h: l }),
      ...
      _drawGrid: function () {
        ...
        if (
          ...
          for (
            a.save(), a.lineWidth = l, a.strokeStyle = u, a.setLineDash && (a.setLineDash(Vn([s.borderDash, o.borderDash, []])), (a.lineDashOffset = Vn([s.borderDashOffset, o.borderDashOffset, 0]))), t = i.chart.data.labels.length - 1;
            t >= 0;
            t--
          )
      ...
      determineDataLimits: function () {
        ...
        for (t = 0, n = (l.data.datasets || []).length; t < n; ++t)
          if (l.isDatasetVisible(t))
            if (((a = l.data.datasets[t].data), B.isObject(a[0]))) for (m[t] = [], e = 0, i = a.length; e < i; ++e) (r = ui(s, a[e])), g.push(r), (m[t][e] = r);
  ...
  function ki(t, e, n, i, a) {
    ...
    if (i && a) {
      ...
      if (void 0 === n[0].angle) for (t.lineTo(n[a - 1].x, n[a - 1].y), r = a - 1; r > 0; --r) B.canvas.lineTo(t, n[r], n[r - 1], !0);
  ...
  function Mi(t, e, n, i, a, r) {
    ...
    for (t.beginPath(), o = 0, s = g; o < s; ++o)
      (d = n((u = e[(l = o % g)]._view), l, i)),
        ...
        h && c ? ((b = p.push(u)), (y = v.push(d))) : b && y && (m ? (h && p.push(u), c && v.push(d)) : (ki(t, p, v, b, y), (b = y = 0), (p = []), (v = [])));
  ...
  var Si = {
      ...
      beforeDatasetsDraw: function (t) {
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            e.visible &&
            ((a = (i = e.el)._view), (r = i._children || []), (o = e.mapper), (s = a.backgroundColor || Y.global.defaultColor), o && s && r.length && (B.canvas.clipArea(u, t.chartArea), Mi(u, r, o, a, s, i._loop), B.canvas.unclipArea(u)));
      },
    },
  ...
  var Li = X.extend({
    ...
    fit: function () {
      var t,
        ...
        a = e.isHorizontal();
      n.display
        ? ((t = (B.isArray(n.text) ? n.text.length : 1) * B.options._parseFont(n).lineHeight + 2 * n.padding), (e.width = i.width = a ? e.maxWidth : t), (e.height = i.height = a ? t : e.maxHeight))
    ...
    (B.where = function (t, e) {
      ...
      (B.longestText = function (t, e, n, i) {
        ...
        for (o = 0; o < c; o++)
          ...
          else if (B.isArray(u)) for (s = 0, l = u.length; s < l; s++) null == (d = u[s]) || B.isArray(d) || (h = B.measureText(t, a, r, h, d));
        var f = r.length / 2;
        if (f > n.length) {
      ...
      (B.getHoverColor = function (t) {
        return t instanceof CanvasPattern || t instanceof CanvasGradient ? t : B.color(t).saturate(0.5).darken(0.1).rgbString();
      });
  })(),
  (nn._adapters = on),
  (nn.Animation = J),
