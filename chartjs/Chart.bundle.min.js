  ...
  })(
    {
      ...
      2: [
        function (t, e, i) {
          ...
          (r.prototype = {
            ...
            (r.prototype.spaces = { rgb: ['red', 'green', 'blue'], hsl: ['hue', 'saturation', 'lightness'], hsv: ['hue', 'saturation', 'value'], hwb: ['hue', 'whiteness', 'blackness'], cmyk: ['cyan', 'magenta', 'yellow', 'black'] }),
          ...
          (n = this),
            (a = function () {
              ...
              function jt(t, e, i) {
                ...
                return o < 1 ? (n = o + Ut((a = t.year() - 1), e, i)) : o > Ut(t.year(), e, i) ? ((n = o - Ut(t.year(), e, i)), (a = t.year() + 1)) : ((a = t.year()), (n = o)), { week: n, year: a };
              }
              function Ut(t, e, i) {
                var n = Bt(t, e, i),
                  a = Bt(t + 1, e, i);
              ...
              function de(t, e) {
                if (null !== e) {
                  ...
                  if (((e.abbr = t), null != re[t]))
                    ...
                    if (null == re[e.parentLocale]) return oe[e.parentLocale] || (oe[e.parentLocale] = []), oe[e.parentLocale].push({ name: t, config: e }), null;
                ...
                if (!t._d) {
                  ...
                  for (
                    l = t,
                      ...
                      null != t._dayOfYear &&
                        ((o = fe(t._a[pt], n[pt])), (t._dayOfYear > St(o) || 0 === t._dayOfYear) && (g(t)._overflowDayOfYear = !0), (i = Vt(o, 0, t._dayOfYear)), (t._a[vt] = i.getUTCMonth()), (t._a[yt] = i.getUTCDate())),
                      e = 0;
                    e < 3 && null == t._a[e];
                    ++e
                  )
                  ...
                  24 === t._a[bt] && 0 === t._a[xt] && 0 === t._a[_t] && 0 === t._a[kt] && ((t._nextDay = !0), (t._a[bt] = 0)),
                    (t._d = (
                      t._useUTC
                        ? Vt
                ...
                if (t._f !== a.ISO_8601)
                  if (t._f !== a.RFC_2822) {
                    ...
                    (g(t).charsLeftOver = c - f),
                      ...
                      t._a[bt] <= 12 && !0 === g(t).bigHour && t._a[bt] > 0 && (g(t).bigHour = void 0),
                    ...
                    : ('string' == typeof f && (t._i = f = t._locale.preparse(f)),
                      _(f)
                        ...
                        : (u(f)
                            ...
                            : 'string' == typeof i
                            ? ((n = e), null === (h = xe.exec(n._i)) ? (_e(n), !1 === n._isValid && (delete n._isValid, Se(n), !1 === n._isValid && (delete n._isValid, a.createFromInputFallback(n)))) : (n._d = new Date(+h[1])))
                            : r(i)
              ...
              function Pe(t, e, i, n, a) {
                ...
                return (
                  ...
                  (l._f = e),
                  (l._strict = n),
                  (s = new x(ce(Ce(l))))._nextDay && (s.add(1, 'd'), (s._nextDay = void 0)),
                  s
                );
              }
              function Te(t, e, i, n) {
              ...
              function Ue(t, e) {
                ...
                return (
                  Le(t)
                    ...
                    : (o = Ee.exec(t))
                    ? ((i = '-' === o[1] ? -1 : 1), (r = { y: 0, d: w(o[yt]) * i, h: w(o[bt]) * i, m: w(o[xt]) * i, s: w(o[_t]) * i, ms: w(We(1e3 * o[kt])) * i }))
                    : (o = je.exec(t))
                    ? ((i = '-' === o[1] ? -1 : (o[1], 1)), (r = { y: qe(o[2], i), M: qe(o[3], i), w: qe(o[4], i), d: qe(o[5], i), h: qe(o[6], i), m: qe(o[7], i), s: qe(o[8], i) }))
                    : null == r
                    ? (r = {})
                    : 'object' == typeof r &&
                      ('from' in r || 'to' in r) &&
              ...
              function Ze(t, e) {
                return function (i, n) {
                  ...
                  return (
                    null === n ||
                      isNaN(+n) ||
                      (T(e, 'moment().' + e + '(period, number) is deprecated. Please use moment().' + e + '(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info.'), (a = i), (i = n), (n = a)),
              ...
              (di.add = Je),
                ...
                (di.isSame = function (t, e) {
                  var i,
                    n = _(t) ? t : Te(t);
                  return (
                    !(!this.isValid() || !n.isValid()) && ('millisecond' === (e = L(e || 'millisecond')) ? this.valueOf() === n.valueOf() : ((i = n.valueOf()), this.clone().startOf(e).valueOf() <= i && i <= this.clone().endOf(e).valueOf()))
                  );
                }),
                ...
                (di.utcOffset = function (t, e, i) {
                  ...
                  if (null != t) {
                    ...
                    return (
                      ...
                      (this._isUTC = !0),
                      null != n && this.add(n, 'm'),
                      r !== t && (!e || this._changeInProgress ? Xe(this, Ue(t - r, 'm'), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), a.updateOffset(this, !0), (this._changeInProgress = null))),
                      this
                    );
                  }
                ...
                (di.dates = D('dates accessor is deprecated. Use date instead.', ai)),
                (di.months = D('months accessor is deprecated. Use month instead', Yt)),
                (di.years = D('years accessor is deprecated. Use year instead', Pt)),
                (di.zone = D('moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/', function (t, e) {
              ...
              (ci.calendar = function (t, e, i) {
                ...
                (ci.monthsRegex = function (t) {
                  return this._monthsParseExact
                    ...
                    : (h(this, '_monthsRegex') || (this._monthsRegex = zt), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex);
                }),
                (ci.monthsShortRegex = function (t) {
                  return this._monthsParseExact
                    ? (h(this, '_monthsRegex') || Ht.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex)
                    : (h(this, '_monthsShortRegex') || (this._monthsShortRegex = Nt), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex);
                }),
                (ci.week = function (t) {
                ...
                (ci.weekdaysParse = function (t, e, i) {
                  ...
                  for (this._weekdaysParse || ((this._weekdaysParse = []), (this._minWeekdaysParse = []), (this._shortWeekdaysParse = []), (this._fullWeekdaysParse = [])), n = 0; n < 7; n++) {
                    if (
                      ...
                      this._weekdaysParse[n] || ((r = '^' + this.weekdays(a, '') + '|^' + this.weekdaysShort(a, '') + '|^' + this.weekdaysMin(a, '')), (this._weekdaysParse[n] = new RegExp(r.replace('.', ''), 'i'))),
                ...
                (ci.weekdaysRegex = function (t) {
                  return this._weekdaysParseExact
                    ? (h(this, '_weekdaysRegex') || $t.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex)
                    : (h(this, '_weekdaysRegex') || (this._weekdaysRegex = Xt), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex);
                }),
                (ci.weekdaysShortRegex = function (t) {
                  return this._weekdaysParseExact
                    ? (h(this, '_weekdaysRegex') || $t.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
                    : (h(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = Jt), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
                }),
                (ci.weekdaysMinRegex = function (t) {
                  return this._weekdaysParseExact
                    ? (h(this, '_weekdaysRegex') || $t.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
                    : (h(this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = Kt), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
                }),
                (ci.isPM = function (t) {
                ...
                (a.lang = D('moment.lang is deprecated. Use moment.locale instead.', ue)),
                (a.langData = D('moment.langData is deprecated. Use moment.localeData instead.', he));
              var pi = Math.abs;
              function vi(t, e, i, n) {
                var a = Ue(e, i);
              ...
              return (
                ...
                (Ei._bubble = function () {
                  var t,
                    ...
                    l = this._data;
                  return (
                    (r >= 0 && o >= 0 && s >= 0) || (r <= 0 && o <= 0 && s <= 0) || ((r += 864e5 * yi(xi(s) + o)), (o = 0), (s = 0)),
                ...
                (Ei.locale = Qe),
                (Ei.localeData = ei),
                (Ei.toIsoString = D('toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)', Bi)),
                (Ei.lang = ti),
                j('X', 0, 0, 'unix'),
                j('x', 0, 0, 'valueOf'),
                dt('x', rt),
            ...
            (e.exports = function (t) {
              t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                ...
                updateElement: function (t, e, i) {
                  ...
                  r.extend(t, { _datasetIndex: n.index, _index: e, _model: { x: u + a.offsetX, y: d + a.offsetY, startAngle: h, endAngle: c, circumference: g, outerRadius: p, innerRadius: m, label: v(f.label, e, a.data.labels[e]) } });
                  var y = t._model;
          ...
          n._set('polarArea', {
            ...
            (e.exports = function (t) {
              t.controllers.polarArea = t.DatasetController.extend({
                ...
                updateElement: function (t, e, i) {
                  for (
                    var n = this, a = n.chart, o = n.getDataset(), s = a.options, l = s.animation, u = a.scale, d = a.data.labels, h = n.calculateCircumference(o.data[e]), c = u.xCenter, f = u.yCenter, g = 0, m = n.getMeta(), p = 0;
                    p < e;
                    ++p
                  )
                  ...
                  r.extend(t, {
                    ...
                    _index: e,
                    _scale: u,
                    _model: { x: c, y: f, innerRadius: 0, outerRadius: i ? _ : y, startAngle: i && l.animateRotate ? v : b, endAngle: i && l.animateRotate ? v : x, label: r.valueAtIndexOrDefault(d, e, d[e]) },
                  }),
      ...
      32: [
        function (t, e, i) {
          ...
          n._set('scale', {
            ...
            ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: o.formatters.values, minor: {}, major: {} },
          }),
            (e.exports = function (t) {
              function e(t, e, i) {
                      ...
                      (r.each(p, function (i, n) {
                        if (!r.isNullOrUndef(i.label)) {
                          ...
                          n === e.zeroLineIndex && a.offset === c.offsetGridLines
                            ...
                            : ((o = r.valueAtIndexOrDefault(c.lineWidth, n)), (s = r.valueAtIndexOrDefault(c.color, n)), (h = r.valueOrDefault(c.borderDash, u.borderDash)), (f = r.valueOrDefault(c.borderDashOffset, u.borderDashOffset)));
                          var W = 'middle',
                            Y = 'middle',
                            N = d.padding;
                          if (m) {
      ...
      37: [
        function (t, e, i) {
          ...
          n._set('global', {
            elements: {
              line: { tension: 0.4, backgroundColor: o.defaultColor, borderWidth: 3, borderColor: o.defaultColor, borderCapStyle: 'butt', borderDash: [], borderDashOffset: 0, borderJoinStyle: 'miter', capBezierPoints: !0, fill: !0 },
            },
          }),
            (e.exports = a.extend({
              draw: function () {
                ...
                for (
                  ...
                  (e = u[t]),
                    ...
                    (n = e._view),
                    0 === t ? n.skip || (s.moveTo(n.x, n.y), (h = t)) : ((i = -1 === h ? i : u[h]), n.skip || ((h !== t - 1 && !l) || -1 === h ? s.moveTo(n.x, n.y) : r.canvas.lineTo(s, i._view, e._view), (h = t)));
                s.stroke(), s.restore();
              },
            }));
        },
              ...
              draw: function (t) {
                ...
                e.skip ||
                  ...
                  void 0 !== t &&
                    ...
                    (i.x < t.left ? (c = (u - i.x) / (t.left - i.x)) : 1.01 * t.right < i.x ? (c = (i.x - u) / (i.x - t.right)) : i.y < t.top ? (c = (d - i.y) / (t.top - i.y)) : 1.01 * t.bottom < i.y && (c = (i.y - d) / (i.y - t.bottom)),
            ...
            a = {
              ...
              easeInElastic: function (t) {
                var e = 1.70158,
                  i = 0,
                  n = 1;
                return 0 === t ? 0 : 1 === t ? 1 : (i || (i = 0.3), n < 1 ? ((n = 1), (e = i / 4)) : (e = (i / (2 * Math.PI)) * Math.asin(1 / n)), -n * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / i));
              },
        ...
        function (t, e, i) {
          ...
          e.exports = {
            ...
            toPadding: function (t) {
              var e, i, a, r;
              return n.isObject(t) ? ((e = +t.top || 0), (i = +t.right || 0), (a = +t.bottom || 0), (r = +t.left || 0)) : (e = i = a = r = +t || 0), { top: e, right: i, bottom: a, left: r, height: e + a, width: r + i };
            },
          ...
          e.exports = {
            ...
            afterDatasetsUpdate: function (t, e) {
              var i,
                ...
                m = e.propagate,
                p = [];
              for (n = 0; n < g; ++n) (d = null), (r = (i = t.getDatasetMeta(n)).dataset) && r._model && r instanceof a.Line && (d = { visible: t.isDatasetVisible(n), fill: s(r, n, g), chart: t, el: r }), (i.$filler = d), p.push(d);
                ...
                if (((o.font = f), p)) {
                  ...
                  (o.textAlign = 'left'),
                    ...
                    r.each(t.legendItems, function (e, n) {
                      ...
                      v[v.length - 1] + a + i.padding >= t.width && ((y += d + i.padding), (v[v.length] = t.left)), (g[n] = { left: 0, top: 0, width: a, height: d }), (v[v.length - 1] += a + i.padding);
                    }),
                    (m.height += y);
                } else {
                  var b = i.padding,
            ...
            draw: function () {
              ...
              if (i.display) {
                ...
                (t.fillStyle = e(i.fontColor, a.defaultFontColor)),
                  (t.font = c),
                  this.isHorizontal() ? ((s = v + (b - v) / 2), (l = p + g), (o = b - v)) : ((s = 'left' === i.position ? v + g : b - g), (l = p + (y - p) / 2), (o = y - p), (m = Math.PI * ('left' === i.position ? -0.5 : 0.5))),
                  t.save(),
                  t.translate(s, l),
                  t.rotate(m),
                  (t.textAlign = 'center'),
              ...
              i = t.Scale.extend({
                      ...
                      i.isDatasetVisible(a) &&
                        ...
                        n.each(e.data, function (e, i) {
                          ...
                          isNaN(n) ||
                            r.data[i].hidden ||
                            n < 0 ||
                            (null === t.min ? (t.min = n) : n < t.min && (t.min = n), null === t.max ? (t.max = n) : n > t.max && (t.max = n), 0 !== n && (null === t.minNotZero || n < t.minNotZero) && (t.minNotZero = n));
                        });
                    });
                ...
                getPixelForValue: function (e) {
                  ...
                  return (
                    ...
                    e !== r && (0 === r && ((i -= c = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize)), (r = h)), 0 !== e && (c += (i / (d(o) - d(r))) * (d(e) - d(r))), (a += s * c)),
                    a
                  );
                },
