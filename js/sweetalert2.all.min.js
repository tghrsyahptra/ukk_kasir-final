!(function (t, e) {
  ...
  function Mt(t, e) {
    ...
    N(l, e, 'header'),
      ...
      (n = t),
      (o = e),
      (r = St.innerParams.get(n)) && o.icon === r.icon && k()
        ? N(k(), o, 'icon')
        : (Dt(),
          o.icon &&
  ...
  var on,
    ...
    an = Object.freeze({
      ...
      _main: function (t) {
        ...
        var n = (function (t) {
          var e = { popup: $(), container: Q(), content: P(), actions: T(), confirmButton: E(), cancelButton: O(), closeButton: I(), validationMessage: B(), progressSteps: S() };
      ...
      update: function (e) {
        ...
        var i = s({}, n, o);
        Rt(this, i), St.innerParams.set(this, i), Object.defineProperties(this, { params: { value: s({}, this.params, e), writable: !1, enumerable: !0 } });
      },
      _destroy: function () {
        var t = St.domCache.get(this),
          e = St.innerParams.get(this);
