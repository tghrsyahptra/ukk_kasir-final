  ...
  ((i = (function () {
    ...
    return (
      ...
      (t.prototype.add_group = function (t) {
        var e, s, i, n, r, o;
        for (
          e = this.parsed.length, this.parsed.push({ array_index: e, group: !0, label: t.label, title: t.title ? t.title : void 0, children: 0, disabled: t.disabled, classes: t.className }), o = [], s = 0, i = (r = t.childNodes).length;
          s < i;
          s++
        )
            ...
            ((r = l[i]).search_match = !1),
              ...
              this.include_option_in_results(r) &&
                ...
                (r.group && !this.group_search) ||
                  ...
                  r.search_match
                    ? (h.length && ((d = u.index), (o = f.slice(0, d)), (s = f.slice(d, d + h.length)), (p = f.slice(d + h.length)), (r.highlighted_html = this.escape_html(o) + '<em>' + this.escape_html(s) + '</em>' + this.escape_html(p))),
    ...
    (s = (function (s) {
      ...
      return (
        ...
        (n.prototype.search_field_scale = function () {
          ...
          if (this.is_multiple) {
            for (
              r = { position: 'absolute', left: '-1000px', top: '-1000px', display: 'none', whiteSpace: 'pre' }, s = 0, i = (o = ['fontSize', 'fontStyle', 'fontWeight', 'fontFamily', 'lineHeight', 'textTransform', 'letterSpacing']).length;
              s < i;
              s++
            )
